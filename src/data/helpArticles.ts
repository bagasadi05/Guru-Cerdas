...
export const helpArticles: HelpArticle[] = [
    ...
    // ============================================
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/attendance.webp" alt="Tampilan Halaman Absensi" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
    ...
    },
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/students.webp" alt="Halaman Data Siswa" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
            ...
            <br/>
            <img src="/images/tutorials/add-student.webp" alt="Form Tambah Siswa" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
    ...
    },
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/schedule.webp" alt="Halaman Jadwal Pelajaran" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
    ...
    },
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/grades.webp" alt="Halaman Input Nilai" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
            ...
            <br/>
            <img src="/images/tutorials/bulk-grades.webp" alt="Halaman Input Nilai Massal" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
    ...
    },
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/tasks.webp" alt="Halaman Manajemen Tugas" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
    ...
    // ============================================
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/analytics.webp" alt="Dashboard Analitik" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
    ...
    },
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/communication.webp" alt="Tab Komunikasi Siswa" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
    ...
    },
    {
        ...
        content: `
            ...
            <img src="/images/tutorials/settings.webp" alt="Halaman Pengaturan" loading="lazy" decoding="async" class="w-full rounded-xl shadow-md mb-6 border border-slate-200 dark:border-slate-700" />
