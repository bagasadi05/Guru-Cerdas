...
const GreetingRobot: React.FC<GreetingRobotProps> = ({ userName, onAnimationEnd }) => {
    ...
    const containerClasses = `fixed inset-x-0 top-0 z-50 flex flex-col items-center justify-center transition-transform transform-gpu`;
    ...
    return (
        <div className={`${containerClasses} ${phaseClasses[phase]}`}>
            <div className="relative flex flex-col items-center">
                <RobotIcon />
                {showBubble && (
                    <div className="relative mt-[-20px] p-4 bg-white dark:bg-gray-800 rounded-xl shadow-lg animate-fade-in text-center border border-gray-200 dark:border-gray-700 mx-4">
