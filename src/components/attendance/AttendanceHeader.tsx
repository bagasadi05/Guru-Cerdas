...
export const AttendanceHeader: React.FC<AttendanceHeaderProps> = ({ onAnalyze, onExport, isOnline }) => {
    return (
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
                <h1 className="text-xl sm:text-2xl font-bold tracking-tight leading-tight text-slate-900 dark:text-white font-serif">Rekapitulasi Kehadiran</h1>
                <p className="mt-1 text-sm font-medium leading-relaxed text-slate-500 dark:text-slate-400">Manajemen data kehadiran peserta didik secara real-time.</p>
            </div>
