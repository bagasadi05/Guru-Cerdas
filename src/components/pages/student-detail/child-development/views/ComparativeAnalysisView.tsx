...
export const ComparativeAnalysisView: React.FC<ChildDevelopmentAnalysisTabProps> = ({
  studentData,
  allAcademicRecords = [],
  ...
  const [activeTabMode, setActiveTabMode] = useState<'single' | 'comparative'>('comparative');
