...
export const PeriodComparison: React.FC<{
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm transition-all p-4 border border-slate-200 dark:border-slate-700 hover:shadow-md transition-shadow duration-300">
