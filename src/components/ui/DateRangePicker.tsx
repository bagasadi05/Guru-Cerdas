    ...
    return (
        <div className={`relative ${className}`}>
            ...
            <button type="button"
                ...
                className="flex items-center gap-2 w-full px-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:border-brand-300 dark:hover:border-brand-600 transition-colors text-left"
            >
                                ...
                                <div className="space-y-1">
                                    {PRESETS.map((preset) => (
                                        <button type="button"
                                            ...
                                            className="w-full text-left px-3 py-2 text-sm rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/20 hover:text-brand-600 dark:hover:text-brand-400 transition-colors whitespace-nowrap"
                                        >
                                            {preset.label}
                                        </button>
                                    ))}
