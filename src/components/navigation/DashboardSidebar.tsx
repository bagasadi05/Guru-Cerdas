        ...
        <div className="relative z-10 flex flex-col h-full p-5">
          <div className="flex items-center gap-4 px-2 mb-8 mt-2">
            ...
            <div>
              ...
              <p className="text-[10px] font-medium text-green-600 dark:text-green-300 tracking-[0.2em] uppercase opacity-80">
                Ecosystem
              </p>
            </div>
          </div>
                ...
                <div className="space-y-1">
                  {section.items.map((item) => (
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 group overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-slate-900 ${
                          isActive
                    ...
                    >
                      {({ isActive }) => (
                        <>
                          ...
                          <item.icon
                            className={`w-5 h-5 relative z-10 transition-transform duration-300 ${isActive ? 'scale-110 text-white' : 'group-hover:scale-110 group-hover:text-green-600 dark:group-hover:text-green-400'}`}
                          />
                          <span
