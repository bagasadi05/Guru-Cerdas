...
const GradeAuditWidget: React.FC<GradeAuditWidgetProps> = ({ data, classes }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-0 overflow-hidden flex flex-col h-full border border-slate-200/60 dark:border-slate-700/60 shadow-sm">
