...
// ============================================
// BRANKAS PAGE SKELETON
// ============================================
export const BrankasPageSkeleton: React.FC = () => (
  <div className="p-4 md:p-6 space-y-6 animate-fade-in">
    <div className="flex items-center justify-between">
      <div className="space-y-2">
        <Skeleton className="h-8 w-48" />
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="glass-card rounded-2xl p-5 space-y-3 text-center">
...
// ============================================
// PEMULIHAN PAGE SKELETON
// ============================================
export const PemulihanPageSkeleton: React.FC = () => (
  <div className="p-4 md:p-6 space-y-6 animate-fade-in">
    <div className="space-y-2">
...
// ============================================
// BINTANG DASHBOARD PAGE SKELETON
// ============================================
export const BintangDashboardPageSkeleton: React.FC = () => (
  <div className="p-4 md:p-6 space-y-6 animate-fade-in">
    <div className="flex items-center justify-between">
      <div className="space-y-2">
        <Skeleton className="h-8 w-56" />
...
// ============================================
// MODUL AJAR CREATOR PAGE SKELETON
// ============================================
export const ModulAjarCreatorPageSkeleton: React.FC = () => (
  <div className="p-4 md:p-6 space-y-6 animate-fade-in max-w-4xl mx-auto">
    <div className="space-y-2">
      <Skeleton className="h-8 w-56" />
      <Skeleton className="h-4 w-80" />
...
// ============================================
// EXTRACURRICULAR PAGE SKELETON
// ============================================
export const ExtracurricularPageSkeleton: React.FC = () => (
  <div className="p-4 md:p-6 space-y-6 animate-fade-in">
    <div className="flex items-center justify-between">
      <div className="space-y-2">
        <Skeleton className="h-8 w-48" />
          ...
          <div className="flex justify-between items-center">
            <div className="flex -space-x-2">
              {Array.from({ length: 3 }).map((_, j) => (
                <Skeleton key={j} className="w-8 h-8 rounded-full border-2 border-white dark:border-slate-800" />
              ))}
            </div>
