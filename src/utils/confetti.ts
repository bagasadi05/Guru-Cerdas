...
let confettiModule: Confetti | null = null;

async function getConfetti(): Promise<Confetti> {
    if (!confettiModule) {
...
function runConfetti(callback: (confetti: Confetti) => void): void {
