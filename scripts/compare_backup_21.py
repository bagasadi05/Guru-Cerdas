...
backup_file = "data/backups_daily_2026-07-21T19-00-05-027Z_backup.json"

with open(backup_file, "r", encoding="utf-8") as f:
    backup = json.load(f)

tables = backup.get("data", {})
print("--- BACKUP 21 JULY 2026 SUMMARY ---")
...
for s in students:
    ...
    if c_name not in by_class:
        by_class[c_name] = {"active": 0, "deleted": 0}
...
print("\n--- BACKUP 21 JULY STUDENTS BREAKDOWN BY CLASS ---")
